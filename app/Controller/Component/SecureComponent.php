<?php
    class SecureComponent extends Component {
         ...
         * $this->Secure->requirePasswordExcept(array('www.website.com', $_SERVER, $this->Session [,1234]);
         */
         ...
         */
        function requirePasswordForTestingSites($server, $session, $password = false) {
            ...
            if ($password) {
                ...
                if (isset($server['HTTP_HOST'])) {
                    ...
                    if (strpos($server['HTTP_HOST'], 'testing') !== false) {
